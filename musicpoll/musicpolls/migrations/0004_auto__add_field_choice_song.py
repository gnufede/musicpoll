...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Choice.song'
        db.add_column('musicpolls_choice', 'song',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['musicpolls.Song']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Choice.song'
        db.delete_column('musicpolls_choice', 'song_id')
    ...
    models = {
        ...
        'musicpolls.choice': {
            ...
            'song': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['musicpolls.Song']"}),
